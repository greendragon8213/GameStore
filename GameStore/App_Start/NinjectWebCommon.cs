using GameStore.BusinesLogic.Ninject;
using GameStore.Data.Ninject;
...
namespace GameStore.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            //Here we should register our Ninject Moduls!!!

            kernel.Load<NinjectDataContainer>();
            kernel.Load<NinjectBLContainer>();
